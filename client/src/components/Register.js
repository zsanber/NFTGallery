          ...
          <div className="position-absolute top-50 start-50 translate-middle">
              <div className="box">
                  <form onSubmit={handleSubmit(onSubmit)}>
                      ...
                      {errors.userName && <p className="err text-secondary small">Username is required</p>}
                      ...
                      {errors.email && <p className="err text-secondary small">Email address is required</p>}
